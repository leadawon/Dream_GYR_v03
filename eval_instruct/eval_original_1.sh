# PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 accelerate launch --main_process_port 12334 -m lm_eval \
#     --model diffllm \
...
# PYTHONPATH=. CUDA_VISIBLE_DEVICES=0,1 accelerate launch --main_process_port 12339 -m lm_eval \
#     --model diffllm \
...
# HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
#     --model diffllm \
...
HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=768,diffusion_steps=512,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks humaneval_instruct \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 0 \
    --output_path output_reproduce_limit9999/humaneval/step_512 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template

HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=768,diffusion_steps=384,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks humaneval_instruct \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 0 \
    --output_path output_reproduce_limit9999/humaneval/step_384 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template

HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=768,diffusion_steps=128,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks humaneval_instruct \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 0 \
    --output_path output_reproduce_limit9999/humaneval/step_128 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template

HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=768,diffusion_steps=64,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks humaneval_instruct \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 0 \
    --output_path output_reproduce_limit9999/humaneval/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 0 \
    --limit 30 \
    --output_path output_reproduce_limit30/humaneval/step_512 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 0 \
    --limit 30 \
    --output_path output_reproduce_limit30/humaneval/step_384 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 0 \
    --limit 30 \
    --output_path output_reproduce_limit30/humaneval/step_128 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 0 \
    --limit 30 \
    --output_path output_reproduce_limit30/humaneval/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
#     --num_fewshot 0 \
#     --limit 20 \
#     --output_path output_reproduce_limit20/mbpp \
#     --log_samples --confirm_run_unsafe_code \
#     --apply_chat_template
...
#     --batch_size 1 \
#     --num_fewshot 0 \
#     --output_path output_reproduce_limit9999/mbpp \
#     --log_samples --confirm_run_unsafe_code \
#     --apply_chat_template
