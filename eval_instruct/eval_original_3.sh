...
# PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
#     --model diffllm \
#     --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=128,diffusion_steps=128,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
#     --tasks mmlu_pro \
#     --device cuda \
...
#     --num_fewshot 4 \
#     --limit 180 \
#     --output_path output_reproduce_limit180/mmlu_pro/step_128 \
#     --log_samples --confirm_run_unsafe_code \
#     --apply_chat_template

PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=128,diffusion_steps=96,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks mmlu_pro \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 4 \
    --limit 180 \
    --output_path output_reproduce_limit180/mmlu_pro/step_96 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template

PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=128,diffusion_steps=64,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks mmlu_pro \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 4 \
    --limit 180 \
    --output_path output_reproduce_limit180/mmlu_pro/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template

PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    --model diffllm \
    --model_args pretrained=Dream-org/Dream-v0-Instruct-7B,trust_remote_code=True,max_new_tokens=128,diffusion_steps=32,dtype="bfloat16",temperature=0.1,top_p=0.9,alg="entropy" \
    --tasks mmlu_pro \
    --device cuda \
    --batch_size 1 \
    --num_fewshot 4 \
    --limit 180 \
    --output_path output_reproduce_limit180/mmlu_pro/step_32 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu_pro/step_128 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reprooutput_reproduce_limit9999duce_limit180/mmlu_pro/step_96 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu_pro/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu_pro/step_32 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
