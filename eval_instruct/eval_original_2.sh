...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu/step_128 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu/step_96 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --batch_size 1 \
    --num_fewshot 4 \
    --output_path output_reproduce_limit9999/mmlu/step_32 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 4 \
    --limit 480 \
    --output_path output_reproduce_limit480/mmlu/step_128 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 4 \
    --limit 480 \
    --output_path output_reproduce_limit480/mmlu/step_96 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 4 \
    --limit 480 \
    --output_path output_reproduce_limit480/mmlu/step_64 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 accelerate launch --main_process_port 12334 -m lm_eval \
    ...
    --num_fewshot 4 \
    --limit 480 \
    --output_path output_reproduce_limit480/mmlu/step_32 \
    --log_samples --confirm_run_unsafe_code \
    --apply_chat_template
